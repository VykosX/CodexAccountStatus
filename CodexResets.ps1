...
function Update-CodexResetsDashboard {
...
function Start-CodexResetsBrowser {
...
Update-CodexResetsDashboard -ForceLiveRefresh:$Update
if ($Update) {
  return
}
...
if (-not $SkipBrowser) {
  Start-CodexResetsBrowser "${prefix}index.html"
}
